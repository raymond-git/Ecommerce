                    ...
                    <div className="lg:flex justify-between gap-8">
                                    ...
                                    <div className="shopping_cart_border_color rounded-xl lg-shadow p-10 mb-8 lg:p-0">
                                        <div className="lg:flex justify-between lg:mr-20">
                                            ...
                                            <div className="lg:flex-1 lg:ml-6 lg:mb-10">
                                                ...
                                                <p className="text-sm md:text-base leading-6 pt-4 font-sans">{cartItem.itemProduct.description}</p>
                                                <div className="flex justify-start mt-4">
                                                    ...
                                                    <div key={index} className="quantity-count md:w-20 lg:w-20 lg:h-6 ml-4">
                                                        ...
                                                        <input type="text" className="quantity-input" onChange={handleOnChange} value={cartItem.itemQuantity} />
                                                        <button onClick={() => handleIncreaseCart(cartItem)} className="increment-btn">+</button>
                                                    </div>
                                                </div>
                                                <div className="pt-8 flex flex-col gap-4">
                                                    <div className="icon-container">
                                                        <button onClick={() => handleRemoveButton(cartItem)} className="delete-button p-2">
                        ...
                        <div className="col-lg-3 px-0">
                            <div className="card mb-4">
                                ...
                                <div className="card-body p-4 flex flex-row align-items-center">
                                ...
                                <div className="card-body">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                                            <div>
                                                <strong className="font-sans text-sm lg:text-base">Total amount</strong>
                                            </div>
