...
const EmptyCart = () => {
    return (
        <div className="p-14 mt-28 flex flex-col items-center">
            <div>
                <h1 className="robotoFont font-bold text-xl md:text-2xl text-center pb-6">SHOPPING CART</h1>
            </div>
            ...
            <div>
                <h1 className="robotoFont font-bold text-2xl md:text-3xl text-center pb-6 mt-8">Your Cart is Currently Empty!</h1>
            </div>
            <Link to={`/products`}><button type="button" className="mobile-responsive-emptycart-btn btn btn-primary btn-lg robotoFont rounded-3xl flex items-center lg:h-12 lg:btn-lg my-8 h-10">Return to Shop</button></Link>
        </div>
    );
}
