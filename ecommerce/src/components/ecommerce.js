...
const Ecommerce = () => {
    ...
    return (
        <div className="ecommerce_background_color">
            <Navbar></Navbar>
            <h1 className="mobile-responsive-title-margin robotoFont font-bold text-3xl md:text-4xl pl-16 mt-12">All Products</h1>
                    ...
                    <div key={index}>
                        <div className="ecommerce_border_color rounded-xl lg-shadow w-full h-full flex flex-col justify-between p-12">
                            <Link className="hover-product" to={`/${product.id}`}>
                                ...
                                <h1 className="mobile-responsive-font-ecommerce-title robotoFont text-base md:text-xl mt-10">{product.title} </h1>
                                <p className="mobile-responsive-fontprice-product robotoFont font-bold text-base md:text-lg pt-4 price-color">Price: ${product.price}</p>
                            </Link>
