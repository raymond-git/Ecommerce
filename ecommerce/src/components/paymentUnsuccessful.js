        ...
        <div>
            ...
            <div className="mt-20">
                <div className="flex flex-col items-center gap-20">
                    ...
                    <h1 className="font-sans font-bold lg:font-bold text-xl md:text-2xl lg:text-4xl payment-unsuccessful-text-color">Payment was Unsuccessful</h1>
                </div>
                <div className="mt-4">
                    <div className="flex flex-col items-center lg:gap-8">
                        <p className="font-medium lg:font-medium text-lg md:text-xl lg:text-2xl">We're here to help.</p>
